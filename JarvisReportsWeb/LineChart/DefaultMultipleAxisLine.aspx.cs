...
public partial class Default2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ds.Tables.Count > 0)
        {
            ...
            var chartAxisY = new ChartAxisY { AxisTickText = { Format = "{text}" }, Title = { Text = "Y Axis" } , SwapLocation = true, Min = 10};
            ShieldChart1.Axes.Add(item: chartAxisY);
            chartAxisY = new ChartAxisY { AxisTickText = { Format = "{text}" }, Title = { Text = "Y1 Axis" },Max = 900,Min = 10, };
            ...
            var chartlineseries = new ChartLineSeries
            {
                DataFieldY = "amount",
            ...
            chartlineseries = new ChartLineSeries
             {
