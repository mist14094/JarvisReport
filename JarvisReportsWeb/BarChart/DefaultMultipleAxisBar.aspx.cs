...
public partial class Default2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (ds.Tables.Count > 0)
        {
            ...
            chartAxisY = new ChartAxisY { AxisTickText = { Format = "{text}" }, Title = { Text = "New Axis" },Min = 0, Max = 200, SwapLocation = true};
            var plotLines = new ChartPlotLine {Start = 100, DrawWidth = 20, DrawColor = Color.GreenYellow};

            chartAxisY.PlotLines.Add(item: plotLines);
